<template>
  ...
  <div>
    <div style="margin-bottom: 5px">
      <el-card>
        <el-input v-model="data.productName" placeholder="请输入产品名称查询" style="width: 240px; margin-right: 10px" prefix-icon="Search"></el-input>
        <el-input v-model="data.specification" placeholder="请输入产品规格查询" style="width: 240px; margin-right: 10px" prefix-icon="Search"></el-input>
    ...
    <el-dialog v-model="data.formVisible" title="产品信息" width="500" destroy-on-close>
      <el-form ref="formRef" :rules="data.rules" :model="data.form" style="padding-right: 40px; padding-top: 20px" label-width="80px">
        ...
        <el-form-item label="产品规格" prop="specification">
          <el-input v-model="data.form.specification" autocomplete="off" placeholder="请输入产品规格"/>
        </el-form-item>
      </el-form>
      <template #footer>
