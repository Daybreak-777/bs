  ...
  <div>
    ...
    <div style="margin-bottom: 5px">
      <el-card>
        ...
        <el-input v-model="data.materialName" placeholder="请输入产品查询" style="width: 240px; margin-right: 10px" prefix-icon="Search"></el-input>
        <el-input v-model="data.supplier" placeholder="请输入生产车间查询" style="width: 240px; margin-right: 10px" prefix-icon="Search"></el-input>
    ...
    <div style="margin-bottom: 5px">
      <el-card>
        <el-table :data="data.tableData" stripe @selection-change="handleSelectionChange">
          ...
          <el-table-column label="生产车间" prop="supplier" />
