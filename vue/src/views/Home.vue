...
<!--          <img :src="item" width="100%" height="200px">-->
      ...
      <el-table :data="data.tableData" style="width: 100%" stripe border>
        ...
        <el-table-column prop="delete" label="操作">
          <template #default="scope">
            <el-button
                type="primary"
                @click.prevent="editContent(scope.row)"
            >
              编辑富文本
            </el-button>
            <el-button
    ...
    <el-dialog v-model="data.formContentVisible" title="编辑富文本" >
      ...
      <template #footer>
        <div class="dialog-footer">
          ...
          <el-button type="primary" @click="saveConetent">保 存</el-button>
        </div>
      </template>
    </el-dialog>
...
const data = reactive({
  ...
  tableData: [
    ...
    },
    {
      ...
      name: 'Tom',
      address: 'No. 189, Grove St, Los Angeles',
      content: '<h1 style="color: red">哈哈哈</h1>',
    },
    {
      date: '2016-05-04',
      name: 'Tom',
      address: 'No. 189, Grove St, Los Angeles',
      content: '<h1 style="font-size: 12px">哈哈哈</h1>',
    },
    {
      date: '2016-05-01',
      name: 'Tom',
...
const editorRef = shallowRef() // 编辑器实例，必须勇 shallowRef
const mode = 'default'
