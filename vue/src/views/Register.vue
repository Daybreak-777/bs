    ...
    <div class="login-box">
      <div style="padding: 50px 30px; background-color: white; margin-left: 100px; border-radius: 5px; box-shadow: 0 0 10px rgba(0,0,0,1)">
        <el-form ref="formRef" :rules='data.rules' :model="data.form" style="width: 300px">
          <div style="margin-bottom: 30px; font-size: 24px; text-align:center; color: #3c7fff; font-weight: bold">欢 迎 注 册</div>
          <el-form-item prop="no">
            <el-input size="large" v-model="data.form.no" placeholder="请输入工号" prefix-icon="User"/>
          </el-form-item>
          ...
          <div style="text-align: right">
            还没有账号？ 请 <a style="color: #3c7fff; text-decoration: none" href="/login">登录</a>
          </div>
        </el-form>
      </div>
    </div>
